...
- [ ] **Step 8: Wire the search box into the home page**
...
Task 17 creates `TrackPrompt`. The page will not compile until that task completes, which is expected.
...
- [ ] **Step 10: Verify the whole flow builds and runs**
